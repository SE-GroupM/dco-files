...
Slider.create({
  ...
  setSlideContent: function(slideDiv, slideData, slideIndex) {
      ...
      firstCard.find(".title").html(truncateText(firstProduct.title.value, 12));
      firstCard.find(".product_description").html(truncateText(firstProduct.product_description.value, 12));
      ...
      secondCard.find(".title").html(truncateText(secondProduct.title.value, 12));
      secondCard.find(".product_description").html(truncateText(secondProduct.product_description.value, 12));
      ...
      thirdCard.find(".title").html(truncateText(thirdProduct.title.value, 12));
      thirdCard.find(".product_description").html(truncateText(thirdProduct.product_description.value, 12));
      ...
      fourthCard.find(".title").html(truncateText(fourthProduct.title.value, 12));
      fourthCard.find(".product_description").html(truncateText(fourthProduct.product_description.value, 12));
