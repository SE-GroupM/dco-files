...
var logoColor= content.logoColor_D82316_FFF_ebe2d6_474542.value; // Logo color source
...
var overlayColor= content.overlay_color.value; // Image color overlay source
var overlayOpacity= content.overlay_opacity.value; // Image color overlay source
...
var copyColor = content.mainCopy_color.value; //Color of main copy
var copyFontSize = content.mainCopy_fontsize.value; //Font size of main copy
// Append main copy
$('#mainCopy').css({
  'color': copyColor,
...
for (var i = 0; i < 3; i++){
  ...
  // Append cta copy
  var ctaCopy = content.ctaText.value;
  $('#cta_'+i).html(ctaCopy);

  var ctaCopyColor = content.cta_copy_color.value; //Color of cta copy
  var ctaBgcolor = content.cta_color.value; //Color of cta background
  // Append cta color
  $('#cta_'+i).css({
    'color': ctaCopyColor,
