...
onLemonpiReady(function () {
  ...
  $('#frame1-headline').html(local_content.Frame_1_Text_640_formats.value); // Text for the first image
  $('#frame2-headline').html(local_content.Frame_2_Text_640_formats.value); // NEW Lemonpi field for the second image's main text
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // SEENTHIS variables
    var videoSrc = content.Video_640x360_src.value;
    var videoTracker = content.Video_640x360_tracker.value;
    ...
    function onClick (event) {
      return window.dispatchEvent(
        new CustomEvent('lemonpi.interaction/click', {
          detail: {
            placeholder: 'landingpage_640x360'
          }
      }));
    }
