...
onLemonpiReady(function () {
  ...
  $('#frame1-headline').html(local_content.Frame_1_Text_panorama.value); // Text for the first image
  $('#frame2-headline').html(local_content.Frame_2_Text_panorama.value); // NEW Lemonpi field for the second image's main text
    ...
    function onClick (event) {
      return window.dispatchEvent(
        new CustomEvent('lemonpi.interaction/click', {
          detail: {
            placeholder: 'landingpage_980x300'
          }
      }));
    }
