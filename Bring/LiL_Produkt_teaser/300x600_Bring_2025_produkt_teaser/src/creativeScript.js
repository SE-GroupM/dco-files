...
onLemonpiReady(function () {
  lemonpi.subscribe(function callback(content) {
    ...
    //$('#lower_part_headline_text').html(local_content.Frame_1_Text_2.value);
    ...
    var frame1Text1 = local_content.Frame_1_Text_1.value;
    var frame1Text2 = local_content.Frame_1_Text_2.value;
    var frame1Text3 = local_content.Frame_1_Text_3.value;
