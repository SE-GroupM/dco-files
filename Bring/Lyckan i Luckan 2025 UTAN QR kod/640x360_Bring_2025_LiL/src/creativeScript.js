...
onLemonpiReady(function () {
  lemonpi.subscribe(function callback(content) {
    ...
    $('#main-headline').html(local_content.Frame_1_Text_640_formats.value);
    $('#frame2-headline').html(local_content.Frame_2_Text_640_formats.value);
  ...
  frame1_display_duration = 2;
  frame2_display_duration = 2;
  frame3_display_duration = 4;
