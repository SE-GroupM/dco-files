...
onLemonpiReady(function () {
  lemonpi.subscribe(function callback(content) {
    ...
    $('#main-headline').html(local_content.Frame_1_Text.value);
    $('#frame2-headline').html(local_content.Frame_2_Text.value);
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////
      ...
      var videoSrc = content.Video_980x300_src.value;
      var videoTracker = content.Video_980x300_tracker.value;
  ...
  let fade_transition_duration = parseFloat(local_content.fade_transition_duration.value) || 0.4; // Duration for fade in/out transitions
  ...
  gsap.set('#mobile-cta-section', { opacity: 0, scale: 0.8 });
  ...
  var masterTimeline = gsap.timeline({
      ...
      onComplete: function() {
          ...
          gsap.to('#mobile-cta-section', { opacity: 1, scale: 1, duration: fade_transition_duration, ease: 'power1.out' });
  ...
  .to(['#frame3-top-logo', '#mobile-cta-section'], {
      opacity: 1,
  ...
  .to(['#frame3-top-logo', '#mobile-cta-section', '#qr-text'], {
      opacity: 0,
      duration: fade_transition_duration,
      ease: 'power1.in'
