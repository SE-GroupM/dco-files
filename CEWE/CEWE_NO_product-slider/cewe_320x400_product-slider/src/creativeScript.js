...
onLemonpiReady(function () {
  lemonpi.subscribe(function callback(content) {
    ...
    for (var i = 0; i < 4; i++){ 
      ...
      truncateProductText('#productDescription_'+i, 75)
  ...
  function onClick(event) {
    ...
    else if (x >= 10 && x <= 290 && currentSlide === 2) {
      window.dispatchEvent(new CustomEvent('lemonpi.interaction/click', {
        detail: {
    ...
    else if (x >= 10 && x <= 290 && currentSlide === 3) {
      window.dispatchEvent(new CustomEvent('lemonpi.interaction/click', {
        detail: {
    ...
    else if (x >= 10 && x <= 290 && currentSlide === 4) {
      window.dispatchEvent(new CustomEvent('lemonpi.interaction/click', {
        detail: {
