...
window.addEventListener('lemonpi.content/ready', event => {
  ...
  $(".main_copy").css({"font-size": local_content.maincopy_fontsize.value, "line-height": local_content.maincopy_fontsize.value + 2});
  //Append copy to frame 2
  $("#sub_copy").html(local_content.sub_copy.value);
  //Append font size and line height to main_copy
  $(".sub_copy").css({"font-size": local_content.subcopy_fontsize.value, "line-height": local_content.subcopy_fontsize.value + 2});
  //Append sub_copy 
