  ...
  if (ccVideo != '') {
    ...
    function updateProductDisplay(index) {
      ...
      if (productPriceType === 'regular') {
        ...
        if (tempNormal[1] > 0) {
          $('#regularPrice').html('JulaClub <br><span style="font-size: 62px; line-height: 33px;">' + tempNormal[0] + '<span class="priceSup">' + tempNormal[1] + '</span></span>');
        } else {
          $('#regularPrice').html('JulaClub <br><span style="font-size: 62px; line-height: 53px;">' + tempNormal[0] + '<span style="letter-spacing: -7px; padding-right: 8px;">.-</span>');
        }
      ...
      function adjustElementsBasedOnCampaignText(campaignText) {
        if (!campaignText || campaignText.trim() === "") {
            ...
            if (productBox) {
                ...
                productImage.style.width = "290px";
                productImage.style.height = "300px";
            }
    
            if (productInfo) {
                productInfo.style.top = "-35px";
                priceInfo.style.top = "582px";
            }
        }
    }
