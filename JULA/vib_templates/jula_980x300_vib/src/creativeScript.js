...
onLemonpiReady(function () {
  ...
  main_timeline.fromTo('#productBox', 0.4, { opacity: 0,y: -300 }, { opacity:1,y: 0,ease:"Power1.easeInOut"}, 0.1)
  .from('#productInfo',0.6,{autoAlpha:0},0.2)
  .to('#productBox', 0.3, { y: 300 }, "+=3.5")
  .to('#productInfo',0.25,{autoAlpha:0},4.2)
