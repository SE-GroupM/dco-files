...
onLemonpiReady(function () {
  lemonpi.subscribe(function callback(content) {
    ...
    if (productPriceType === 'regular') {
      ...
      if (tempNormal[1] > 0o0) {
        //Ex. 88.88
        $('#regularPrice').html('JulaClub <br><span style="font-size: 72px; line-height: 42px;">' + tempNormal[0] + '<span class="priceSup">' + tempNormal[1]  + '</span></span>');
      } else {
        //Ex. 88,-
