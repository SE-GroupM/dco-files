  ...
  lemonpi.subscribe(function callback(content) {
    ...
    if (productPriceType === 'regular') {
      ...
      if (tempNormal[1] > 0o0) {
        ...
        //Ex. 88,-
        $('#regularPrice').html('JulaClub<br><span style="font-size: 40px; line-height: 34px;">' + tempNormal[0] + '<span style="letter-spacing: -7px; padding-right: 8px;">.-</span>');
      }
    ...
    if (productSaving !== "0") {
      $('#priceElement').html('Taniej o ' + productSaving + '<span style="letter-spacing: -1px; padding-right: -12px;">.-</span>');
