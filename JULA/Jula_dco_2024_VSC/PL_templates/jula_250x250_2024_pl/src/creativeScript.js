  ...
  lemonpi.subscribe(function callback(content) {
    ...
    if (productPriceType === 'regular') {
      ...
      if (tempNormal[1] > 0o0) {
        ...
        //Ex. 88,-
        $('#regularPrice').html(tempNormal[0] + '<span style="letter-spacing:0px; padding-right: 0px;">.-</span>');
      }
      ...
      if (tempNormal[1] > 0o0) {
        ...
        //Ex. 88,-
        $('#regularPrice').html('JulaClub<br><span style="font-size: 40px; line-height: 34px;">' + tempNormal[0] + '<span style="letter-spacing: -8px; padding-right: 8px;">.-</span>');
      }
