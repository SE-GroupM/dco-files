...
onLemonpiReady(function () {
  lemonpi.subscribe(function callback(content) {
    ...
    if (productPriceType === 'regular') {
      ...
      if (tempNormal[1] > 0o0) {
        //Ex. 88.88
        $('#regularPrice').html('<span>JulaClub</span> <br><span style="font-size: 72px; line-height: 62px;">' + tempNormal[0] + '<span class="priceSup">' + tempNormal[1]  + '</span></span>');
      } else {
        //Ex. 88,-
        $('#regularPrice').html('<span>JulaClub</span> <br><span style="font-size: 72px; line-height: 62px;">' + tempNormal[0] + '<span style="letter-spacing: -8px; padding-right: 8px;">.-</span>');
      }
