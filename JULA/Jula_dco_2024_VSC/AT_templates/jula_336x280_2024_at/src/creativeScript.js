...
onLemonpiReady(function () {
  ...
  main_timeline.fromTo('#productBox', 0.5, { x: 336 }, { x: 0,ease: Power1.easeInOut }, 0.1)
  .from('#productInfo',0.6,{autoAlpha:0},0.2)
  .to('#productBox', 0.3, { x: -336 }, "+=2.5")
  .to('#productInfo',0.25,{autoAlpha:0},3.2)
  .set('#productBox', { x: 336 }); // Reset to start position for seamless looping
