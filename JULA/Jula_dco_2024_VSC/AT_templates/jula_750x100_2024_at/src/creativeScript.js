...
onLemonpiReady(function () {
  lemonpi.subscribe(function callback(content) {
    ...
    if (tempNormal[1] > 0o0) {
      ...
      //Ex. 88,-
      $('#regularPrice').html(tempNormal[0] + '<span style="letter-spacing: -6px; padding-right: 4px;">.-</span>');
    }
    ...
    if (productPriceType === 'regular') {
      ...
      if (tempNormal[1] > 0o0) {
        ...
        //Ex. 88,-
        $('#regularPrice').html(tempNormal[0] + '<span style="letter-spacing: -4px; padding-right: 4px;">.-</span>');
      }
      ...
      if (tempNormal[1] > 0o0) {
        //Ex. 88.88
        $('#regularPrice').html('JulaClub<br><span style="font-size: 20px; line-height: 30px;">' + tempNormal[0] + '<span class="priceSup">' + tempNormal[1]  + '</span></span>');
      } else {
        //Ex. 88,-
        $('#regularPrice').html('JulaClub<br><span style="font-size: 20px; line-height: 35px;">' + tempNormal[0] + '<span style="letter-spacing: -4px; padding-right: 2px;">.-</span>');
      }
    ...
    if (productSaving !== "0") {
      $('#priceElement').html('Spare ' + productSaving + '<span style="letter-spacing: -4px; padding-right: -2px;">.-</span>');
