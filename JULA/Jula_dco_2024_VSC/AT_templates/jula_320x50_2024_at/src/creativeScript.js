...
onLemonpiReady(function () {
  lemonpi.subscribe(function callback(content) {
    ...
    if (tempNormal[1] > 0o0) {
      ...
      //Ex. 88,-
      $('#regularPrice').html(tempNormal[0] + '<span style="letter-spacing: -2px; padding-right: 4px;">.-</span>');
    }
    ...
    if (productPriceType === 'regular') {
      ...
      if (tempNormal[1] > 0o0) {
        ...
        //Ex. 88,-
        $('#regularPrice').html(tempNormal[0] + '<span style="letter-spacing: -2px; padding-right: 2px;">.-</span>');
      }
      ...
      if (tempNormal[1] > 0o0) {
        ...
        //Ex. 88,-
        $('#regularPrice').html('JulaClub<br><span style="font-size: 20px; line-height: 35px;">' + tempNormal[0] + '<span style="letter-spacing: 1px; padding-right: 2px;">.-</span>');
      }
