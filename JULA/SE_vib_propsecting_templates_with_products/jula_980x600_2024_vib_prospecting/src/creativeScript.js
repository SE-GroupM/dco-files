  ...
  lemonpi.subscribe(function callback(content) {
    ...
    function updateProductDisplay(index) {
      ...
      if (productPriceType === 'regular') {
        ...
        if (tempNormal[1] > 0) {
          $('#regularPrice').html('JulaClub <br><span style="font-size: 72px; line-height: 38px;">' + tempNormal[0] + '<span class="priceSup">' + tempNormal[1] + '</span></span>');
        } else {
          $('#regularPrice').html('JulaClub <br><span style="font-size: 72px; line-height: 78px;">' + tempNormal[0] + '<span style="letter-spacing: -7px; padding-right: 8px;">.-</span>');
        }
