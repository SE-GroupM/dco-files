...
if (parseInt(tempNormal[1]) > 0) {
  ...
  // Ex. 88,-
  $('#regularPrice').html(tempNormal[0] + '<span style="letter-spacing: -11px; padding-right: 8px;">.-</span>');
}
...
$('#productPriceType').html(formattedProductPriceType);
      ...
      if (productPriceType === 'regular') {
        ...
        if (tempNormal[1] > 0) {
          // Ex. 88.88
          $('#regularPrice').html('JulaClub <br><span style="font-size: 55px; line-height: 52px;">' + tempNormal[0] + '<span class="priceSup">' + tempNormal[1] + '</span></span>');
        } else {
          // Ex. 88,-
          $('#regularPrice').html('JulaClub <br><span style="font-size: 55px; line-height: 52px;">' + tempNormal[0] + '<span style="letter-spacing: -8px; padding-right: 8px;">.-</span>');
        }
