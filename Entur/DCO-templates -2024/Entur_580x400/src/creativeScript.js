...
onLemonpiReady(function () {
  lemonpi.subscribe(function callback(content) {
   ...
   // Loop through a specified number of dots
    ...
    tl.fromTo('#bgPanel', 0.5, {x:580,ease: Linear.ease},{x:0, ease: Linear.ease}, 0) //Background panel slides in
      .fromTo('#bgImage', 0.5, {width:580, x:60, ease: Linear.ease},{x:-30,width:580, ease: Linear.ease}, 0) //Background image changes width
      .fromTo('#copyFrame_1', 0.3, {x:980, ease: Linear.ease},{x:0, ease: Linear.ease}, ) //Copy frame 1 in
      .to('#copyFrame_1', 0.3, {x:-580, ease: Linear.ease}, 2.5) //Copy frame 1 out

      .to('#bgPanel', 0.3, {x: -290, ease: Linear.ease}, 2.5) //Background panel covers creative
      ...
      .fromTo('#logo_1', 0.3, {x:0, ease: Linear.ease},{x:-175, ease: Linear.ease}, 2.5) //Logo 1 to center
      .fromTo('#logo_2', 0.3, {x:0, ease: Linear.ease},{x:170, ease: Linear.ease}, 2.5) //Logo 2 to center
