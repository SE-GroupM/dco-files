...
onLemonpiReady(function () {
  lemonpi.subscribe(function callback(content) {
   ...
   // Loop through a specified number of dots
    ...
    tl.fromTo('#bgPanel', 0.5, {y:-600,ease: Linear.ease},{y:-300, ease: Linear.ease}, 0) //Background panel slides in
      ...
      .to('#bgPanel', 0.3, {y: 0, ease: Linear.ease}, 2.5) //Background panel covers creative
