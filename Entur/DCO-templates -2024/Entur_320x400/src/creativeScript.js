...
onLemonpiReady(function () {
  lemonpi.subscribe(function callback(content) {
   ...
   // Loop through a specified number of dots
    ...
    tl.fromTo('#bgPanel', 0.5, {y:-200,ease: Linear.ease},{y:0, ease: Linear.ease}, 0) //Background panel slides in
      .fromTo('#bgImage', 0.5, {y:-60, ease: Linear.ease},{y:0, ease: Linear.ease}, 0) //Background image changes width
      .fromTo('#copyFrame_1', 0.3, {x:320, ease: Linear.ease},{x:0, ease: Linear.ease}, 0) //Copy frame 1 in
      .to('#copyFrame_1', 0.3, {x:-320, ease: Linear.ease}, 2.5) //Copy frame 1 out

      .to('#bgPanel', 0.3, {y: 200, ease: Linear.ease}, 2.5) //Background panel covers creative
