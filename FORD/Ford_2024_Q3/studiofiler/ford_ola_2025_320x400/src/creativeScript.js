...
onLemonpiReady(function () {
  lemonpi.subscribe(function callback(content) {
    ...
    var extraLogoWidth = content.extra_logo_image_width.value;
    var extraLogoHeight = content.extra_logo_image_height.value;
  ...
  // SubCopy static
  var extraLogoImage = $('#extra_logo_image');
  extraLogoImage.css({
     'width': extraLogoWidth,
  ...
  var use_static_bg = content.use_static_bg.value;
    var use_static_bg_bool = false;
    if (use_static_bg == 1 || use_static_bg == 'yes') {
      use_static_bg_bool = true;
    }
