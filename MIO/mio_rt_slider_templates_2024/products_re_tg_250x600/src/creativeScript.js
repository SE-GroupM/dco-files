...
if (headlineHeight > 70) { // Assuming 70px corresponds to 3 rows
  document.querySelector('#subline').style.marginTop = '170px'; // Increase margin for 3 rows

} else if (headlineHeight > 35) { // Assuming 35px corresponds to 2 rows
