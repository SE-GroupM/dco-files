...
if (headlineHeight > 65) {
  document.querySelector('#subline').style.marginTop = '190px';

} else {
  document.querySelector('#subline').style.marginTop = '140px'; // default margin for exactly 25px, adjust as needed
}
