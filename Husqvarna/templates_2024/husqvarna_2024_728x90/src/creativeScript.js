...
window.addEventListener('lemonpi.content/ready', event => {
 ...
 TweenMax.set('#copy_frame_1, #copy_frame_2', { opacity: 0 }) //Opacity on copy elements
  tl.fromTo('#copy_frame_1', 0.3, {lineHeight: '0px', y: 15, opacity:0, ease: Linear.ease},{lineHeight: local_content.copy_fontsize.value, y: 0, opacity:1, ease: Linear.ease}, 0) //Copy frame 1 fade in
    .to('#copy_frame_1', 0.3, {lineHeight: '0px', y: 15, opacity:0, ease: Linear.ease}, 3) //Copy frame 1 fade out
    .fromTo('#copy_frame_2', 0.3, {lineHeight: '0px', y: 15, opacity:0, ease: Linear.ease},{lineHeight: local_content.copy_fontsize.value, y: 0, opacity:1, ease: Linear.ease}, 3.3) //Copy frame 2 fade in
    .to('#copy_frame_2', 0.3, {lineHeight: '0px', y: 15, opacity:0, ease: Linear.ease}, 6) //Copy frame 2 fade out
