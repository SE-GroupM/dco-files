...
onLemonpiReady(function () {
  ...
  var BGvideoSource = '<video id="BG_video" autoplay muted playsinline loop width="930" height="600"><source src="' + local_content.Video_930x600.value + '" type="video/mp4"></video>'; 
  ...
  if (local_content.Use_pulse_right.value.toUpperCase() === "TRUE") {
      $("#pulse_video_right").css("background-image","url(https://assets.lemonpi.io/a/k/0a96553b-ab51-48b0-a390-0d8e0328fca3/Assets/Nordea-DCO-2024/Images/930x600_pulse_right_new.gif)");
  }

  //If use pulse right is true, apply pulse to div
  if (local_content.Use_pulse_left.value.toUpperCase() === "TRUE") {
    $("#pulse_video_left").css("background-image","url(https://assets.lemonpi.io/a/k/7ef5b672-be1e-414e-9290-3f4822aac5c6/Assets/Nordea-DCO-2024/Images/930x600_pulse_left_new.gif)");
  }
