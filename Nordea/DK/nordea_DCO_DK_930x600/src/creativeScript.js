...
onLemonpiReady(function () {
  ...
  if (local_content.Use_pulse_right.value.toUpperCase() === "TRUE") {
      $("#pulse_video_right").css("background-image","url(https://assets.lemonpi.io/a/k/07a8eca7-0102-4d78-a06e-234aed937c81/Assets/Nordea-DCO-2024/Images/930x600_pulse_right.gif)");
  }

  //If use pulse right is true, apply pulse to div
  if (local_content.Use_pulse_left.value.toUpperCase() === "TRUE") {
    $("#pulse_video_left").css("background-image","url(https://assets.lemonpi.io/a/k/0c24d64f-29d1-48c7-88e7-89e4802fafaf/Assets/Nordea-DCO-2024/Images/930x600_pulse_left.gif)");
  }
