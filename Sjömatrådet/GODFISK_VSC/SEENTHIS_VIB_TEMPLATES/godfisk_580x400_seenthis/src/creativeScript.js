...
var videoTracker = local_content.videoTracker.value;
  ...
  function fitTextToContainer() {
    ...
    var minFontSize = 35;  // Minimum font size
    var maxFontSize = 40;  // Maximum font size
    var baseFontSize = 42;  // Base font size for an average-length text
    var characterLimit = 32;  // The character length at which to start reducing font size
