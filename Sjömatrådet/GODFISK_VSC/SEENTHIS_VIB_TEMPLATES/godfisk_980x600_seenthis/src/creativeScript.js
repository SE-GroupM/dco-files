...
var videoTracker = local_content.videoTracker.value;
  ...
  function fitTextToContainer() {
    ...
    var minFontSize = 60;  // Minimum font size
    var maxFontSize = 70;  // Maximum font size
    var baseFontSize = 70;  // Base font size for an average-length text
    var characterLimit = 40;  // The character length at which to start reducing font size
