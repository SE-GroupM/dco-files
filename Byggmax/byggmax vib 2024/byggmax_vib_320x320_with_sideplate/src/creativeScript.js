...
// Animate the second product name
  ...
  const animatePlayer = () => {
    const tl = new TimelineMax({ 
      onComplete: animatePlayer // Restart animation after it completes
    });
  
    tl.to('#player', 10, { 
      y: -30, 
      ease: Power1.easeInOut // Smooth movement up
    })
    .set('#player', { y: 0 }); // Instantly reset position after animation ends
  };
