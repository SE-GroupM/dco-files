...
window.addEventListener('lemonpi.content/ready', event => {
  ...
  var sideplateTopPosition = parseInt(local_content.sideplate_left_position.value); // placeholder to adjust the yellow sideplate
  ...
  $("#sideplate").css({
    "background-image":"url(https://assets.lemonpi.io/a/k/c9bd7eb5-0224-4fae-9e2f-7005ff8114a9/Assets/Byggmax-2025/gul_tejp_980x600.png)",
    "top": sideplateTopPosition+'px',
  });
 ...
 // If we need to adjust video placement in wider formats
  ...
  if (useFullScreenVideo === 'yes') {
    ...
    // Select all elements with the class "seenthis-control-bar"
