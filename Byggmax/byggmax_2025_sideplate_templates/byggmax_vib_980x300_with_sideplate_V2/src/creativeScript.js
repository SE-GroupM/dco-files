...
window.addEventListener('lemonpi.content/ready', event => {
  ...
  var sideplateLeftPosition = parseInt(local_content.sideplate_left_position.value); // placeholder to adjust the yellow sideplate
  var imgLeftPosistion = parseInt(local_content.wide_img_left_position.value);
